...
class BillSplitterService:
    ...
    def split_bill(items_to_split: ItemsToSplit) -> Bill:
        people_and_items_to_split: Dict[PeopleName, List[ItemToSplit]] = BillSplitterService._get_people_and_items_to_split(items_to_split)
        bill: Bill = BillSplitterService._calculate_bill(people_and_items_to_split)
        return bill
